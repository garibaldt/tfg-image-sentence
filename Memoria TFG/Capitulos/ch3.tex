...
Para qué sirve, cuales se suelen utilizar
...
con parámetros aprendidos (que denotaremos mediante $\theta_{0}$) que usaremos para realizar una transformación
fija de la imagen.
...
Entrenaremos el sistema para que aprenda los parámetros $W$ y $b$. (finetuning, backprop on CNN)
